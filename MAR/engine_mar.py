...
from quant.npz import create_npz_from_sample_folder
...
def evaluate(model_without_ddp, vae, model_size_npz, args, epoch, batch_size=16, log_writer=None, cfg=1.0,
             use_ema=True, save_folder='', output_dir=''):
    ...
    print("Trans image to .npz ...")
    create_npz_from_sample_folder(save_folder, model_size_npz, output_dir, img_id)
    print("down!")
